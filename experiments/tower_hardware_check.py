...
def main() -> None:
    ...
    try:
        ...
        # A check that starts while the pad controller is still in its
        # post-open reboot would show dead pads — a false negative
        print("Waiting for the pad controller to come ready")
