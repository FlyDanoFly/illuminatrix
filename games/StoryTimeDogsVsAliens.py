...
class StoryTimeDogsVsAliens(BaseStateMachineGame):
    # Game states
    ...
    def __init__(self, tower_controller: TowerController) -> None:
        ...
        self.towers_in_use, self.story = self._read_file("sound_banks/story_time/dogs_vs_aliens/Story mode_ Stories - Example_ Dog vs Aliens.csv")

        self._towers = tower_controller
        self._towers.load_sound_bank("sound_banks/story_time/dogs_vs_aliens")
